...
declare module "@salesforce/schema/Account.Code_Group__c" {
  const Code_Group__c:any;
  export default Code_Group__c;
}
declare module "@salesforce/schema/Account.Code_Group__r" {
  const Code_Group__r:any;
  export default Code_Group__r;
}
